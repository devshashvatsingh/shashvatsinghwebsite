...
<nav class="navbar navbar-expand-lg navbar-dark menu shadow fixed-top">
    <div class="container">
      <a class="navbar-brand" href="" style="font-size:45px; font-weight: bold;">
        6<!-- <img src="images/logo.png" alt="logo image"> -->
      </a>
  ...
  <div class="container">
    <div class="row align-items-center text-white">
      ...
      <div class="col-md-6 intros text-start">
        ...
        <button type="button" class="rounded-pill btn-rounded"  onclick="#contact">Get in Touch
    ...
    <div class="row pt-2 pb-2 mt-0 mb-3">
      ...
      <div class="col-md-6">
        <div class="bg-white p-4 text-start">
          <p class="fw-light">
            Through our custom Agile development method, we bring your mobile and web app ideas to reality.
We stand out for our top development skills but we are much more than that. We are a genuine strategic business partner.
  ...
  <div class="container">
     ...
     <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
        <div class="services__content">
          ...
          <h3 class="display-3--title mt-1">Digital Marketing</h3>
          <p class="lh-lg">
            We make sure that your dream come true. We achieve this by promoting your business across
            various social media platforms and websites. This will eventually help you reaching the right customers and lead generation.
          </p>
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
        <div class="services__content">
          ...
          <p class="lh-lg">
            We bring your business online. You can easily manage your business online from anywhere along with a Client resource and Enterprise resource management system.
             We always provide an admit panel to handle all the tasks effortlessly.
          </p>
          <button type="button" class="rounded-pill btn-rounded border-primary">Learn more
            <span><i class="fas fa-arrow-right"></i></span>
          </button>
    ...
    <!-- START THE APP DEVELOPMENT CONTENT  -->
    <div class="row">

      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
        <div class="services__content">
          <div class="icon d-block fas fa-code"><i class="icon-android"></i></div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-start">
        <div class="services__pic">
          <img src="images/services/service-4.jpg" alt="App development illustration" class="img-fluid">
        </div>
      </div>
    </div>
  ...
  <!-- START THE CLOUD HOSTING CONTENT  -->
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-start">
        <div class="services__pic">
          <img src="images/services/service-3.png" alt="web development illustration" class="img-fluid">
        </div>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
        <div class="services__content">
          ...
          <p class="lh-lg">
            We make sure that your business never go down. That is why we also provide hosting for
            all types of online businesses at reasonable prices.
          </p>
          <button type="button" class="rounded-pill btn-rounded border-primary">Learn more
            <span><i class="fas fa-arrow-right"></i></span>
          </button>
...
<section id="testimonials" class="testimonials">
  ...
  <div class="container">
    <div class="row text-center text-white">
      ...
      <p class="lead pt-1">Group of professionals</p>
    </div>
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            ...
            <div class="testimonials__card">
              <p class="lh-lg">
                ...
                Hey! I'm Arvind. I am a working professional in Digital marketing and Search engine Optimization having 5+ Years of experience.
            ...
            <div class="testimonials__picture">
              <img src="images/testimonials/arvind.jpeg" alt="client-1 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
            <div class="testimonials__name">
              <h3>Mr. Arvind</h3>
              <p class="fw-light">Business Analyst and Digital Marketing expert</p>
            </div>
          </div>
          ...
          <div class="carousel-item active">
            ...
            <div class="testimonials__card">
              <p class="lh-lg">
                <i class="fas fa-quote-left"></i>
                Hey! I'm Shashvat, A Software Engineer having 100+ project experience and 100% customer satisfaction.
                <i class="fas fa-quote-right"></i>
                <div class="ratings p-1">
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
            ...
            <!-- client picture  -->
            <div class="testimonials__picture">
              <img src="images/testimonials/shashvat1.jpg" alt="client-2 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
            <div class="testimonials__name">
              <h3>Mr. Shashvat</h3>
              <p class="fw-light">Sr. Software Engineer</p>
            </div>
          </div>
          ...
          <div class="carousel-item">
            ...
            <div class="testimonials__card">
              <p class="lh-lg">
                <i class="fas fa-quote-left"></i>
                Hi! I am Shubham. I am product designer and also deals with optimization in database administration.
                <i class="fas fa-quote-right"></i>
                <div class="ratings p-1">
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
            ...
            <!-- client picture  -->
            <div class="testimonials__picture">
              <img src="images/testimonials/shubham.jpeg" alt="client-3 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
            <div class="testimonials__name">
              <h3>Mr. Shubham</h3>
              <p class="fw-light">Product designer</p>
            </div>
          </div>
        </div>
...
<section id="portfolio" class="portfolio">
  <div class="container">
    <div class="row text-center mt-5">
      ...
      <div class="heading-line"></div>
      <p class="lead">
        These are some of our contribution in helping others growing there businesses too.
      </p>
    </div>
    <!-- FILTER BUTTONS  -->
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="images/portfolio/travel.jpg" alt="portfolio 7 image" title="portfolio 7 picture" class="img-fluid">
          <div class="portfolio-info">
            <div class="caption">
              <h4>Maitreyaglobaltour</h4>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="images/portfolio/saree.jpeg" alt="portfolio 8 image" title="portfolio 8 picture" class="img-fluid">
          <div class="portfolio-info">
            <div class="caption">
              <h4>Banshis Banarasi</h4>
              <p>E-commerce Saree business</p>
            </div>
          </div>
        </div>
      </div>
...
<section id="contact" class="get-started">
  <div class="container">
    <div class="row text-center">
      ...
      <div class="heading-line"></div>
      <p class="lh-lg">
        Contact us and get lightning-fast delivery of your websites and apps.
      </p>
    </div>
    ...
    <div class="row text-white">
      ...
      <div class="col-12 col-lg-6 bg-white shadow p-3">
        <div class="form w-100 pb-2">
          <div class="alert alert-success" id="msg" role="alert" style="background-color:#9926F0; color:white;">
  Congratulations! Your ping has been accepted.
</div>
          <h4 class="display-3--title mb-5">start your business</h4>
          <form class="row" id="contactform">
            <div class="col-lg-6 col-md mb-3">
              <input type="text" placeholder="Name" id="nameField" name="nameField" class="shadow form-control form-control-lg">
            </div>
            <div class="col-lg-6 col-md mb-3">
              <input type="email" placeholder="Email Address" id="emailField" name="emailField" class="shadow form-control form-control-lg">
            </div>
            <div class="col-lg-12 mb-3">
              <input type="text" placeholder="Phone" id="phoneField" name="phoneField" class="shadow form-control form-control-lg">
            </div>
            <div class="col-lg-12 mb-3">
              <textarea name="messageField" placeholder="message"  id="messageField" rows="8" class="shadow form-control form-control-lg"></textarea>
            </div>
            <div class="text-center d-grid mt-1">
              <button type="submit" class="btn btn-primary rounded-pill pt-3 pb-3" id="button">
                submit
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div class="contact-box__info">
          <a href="#" class="contact-box__info--title">+91 9792902063</a>
          <p class="contact-box__info--subtitle">  Available 24x7</p>
        </div>
      </div>
      <div class="col-md-3 col-lg-3 contact-box pt-1 d-md-block d-lg-flex d-flex"></div>
      <!-- CONTENT FOR EMAIL  -->
      <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        <div class="contact-box__icon">
        ...
        <div class="contact-box__info">
          <a href="#" class="contact-box__info--title">info@shashvatsingh.in</a>
  ...
  <div class="container mt-5">
    <div class="row text-white justify-content-center mt-3 pb-3">
      <div class="col-12 col-sm-6 col-lg-6 mx-auto">
        <h5 class="text-capitalize fw-bold">Shashvatsingh.in</h5>
        <hr class="bg-white d-inline-block mb-4" style="width: 60px; height: 2px;">
        <p class="lh-lg">
          It's never too late to start our own business. Only If you don't do it right now, then only it's getting late.
        </p>
      </div>
      <div class="col-12 col-sm-6 col-lg-2 mb-4 mx-auto">
        ...
        <ul class="list-inline campany-list">
          ...
          <li><a href="#">Inventory and Databases</a></li>
        </ul>
      </div>
      <div class="col-12 col-sm-6 col-lg-2 mb-4 mx-auto">
      ...
      <div class="col-12 col-sm-6 col-lg-2 mb-4 mx-auto">
        ...
        <hr class="bg-white d-inline-block mb-4" style="width: 60px; height: 2px;">
        <ul class="list-inline campany-list">
          <li><a href="#">+91 9792902063</a></li>
          <li><a href="#">shashvatsingh23@gmail.com</a></li>
          <li><a href="#">info@shashvatsingh.in</a></li>
        </ul>
      </div>
    </div>
  </div>
      ...
      <div class="row text-center text-white">
        <div class="col-12">
          <div class="footer-bottom__copyright">
            &COPY; Copyright 2021 <a href="#">shashvatsingh</a> | Created by <a href="http://www.shashvatsingh.in" target="_blank">shashvatsingh</a><br><br>
